...
A = filter data by case_status=='CERTIFIED';
A1 = group A by (job_title,year);
B = foreach A1 generate FLATTEN(group), COUNT(A.year) as number;
...
STORE F INTO 'home/hduser/Downloads/project5b' USING PigStorage('\t');
